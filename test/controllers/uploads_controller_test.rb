...
class UploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upload" do
    assert_difference("Upload.count") do
      post uploads_url, params: { upload: { body: @upload.body, image: @upload.image, title: @upload.title } }
    end
  ...
  test "should update upload" do
    patch upload_url(@upload), params: { upload: { body: @upload.body, image: @upload.image, title: @upload.title } }
